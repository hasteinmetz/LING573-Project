...
class RobertaModelWrapper:
    def __init__(self, batch_s: int, lr: float, model: RobertaModel = None):
...
def main(args: argparse.Namespace) -> None:
    ...
    if args.model_folder != 'None':
        try:
            ...
            roberta_model = RobertaModelWrapper(args.batch_size, args.learning_rate, model)
        ...
        roberta_model = RobertaModelWrapper(args.batch_size, args.learning_rate)
