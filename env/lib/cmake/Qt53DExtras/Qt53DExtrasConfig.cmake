...
set(Qt53DExtras_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::3DExtras)
    ...
    set(Qt53DExtras_PRIVATE_INCLUDE_DIRS
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.12.9"
        "${_qt53DExtras_install_prefix}/include/qt/Qt3DExtras/5.12.9/Qt3DExtras"
    )
    ...
    foreach(_module_dep ${_Qt53DExtras_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt53DExtras_FIND_VERSION_EXACT}
    ...
    _populate_3DExtras_target_properties(RELEASE "libQt53DExtras.5.12.9.dylib" "" )
