...
set(Qt5Bluetooth_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::Bluetooth)
    ...
    set(Qt5Bluetooth_PRIVATE_INCLUDE_DIRS
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.12.9"
        "${_qt5Bluetooth_install_prefix}/include/qt/QtBluetooth/5.12.9/QtBluetooth"
    )
    ...
    foreach(_module_dep ${_Qt5Bluetooth_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5Bluetooth_FIND_VERSION_EXACT}
    ...
    _populate_Bluetooth_target_properties(RELEASE "libQt5Bluetooth.5.12.9.dylib" "" )
