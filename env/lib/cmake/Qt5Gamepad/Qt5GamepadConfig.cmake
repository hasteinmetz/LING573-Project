...
set(Qt5Gamepad_VERSION_STRING 5.12.9)
...
if (NOT TARGET Qt5::Gamepad)
    ...
    set(Qt5Gamepad_PRIVATE_INCLUDE_DIRS
        "${_qt5Gamepad_install_prefix}/include/qt/QtGamepad/5.12.9"
        "${_qt5Gamepad_install_prefix}/include/qt/QtGamepad/5.12.9/QtGamepad"
    )
    ...
    foreach(_module_dep ${_Qt5Gamepad_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.12.9 ${_Qt5Gamepad_FIND_VERSION_EXACT}
    ...
    _populate_Gamepad_target_properties(RELEASE "libQt5Gamepad.5.12.9.dylib" "" )
